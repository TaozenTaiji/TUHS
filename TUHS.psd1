#
# Module manifest for module 'TUHS'
#
...
@{
    ...
    FunctionsToExport = @('Install-SCCM', 'Get-SCCMPackage','Add-DeviceToCollection','Get-SCCMDeviceLogs','New-AdminSession','Publish-TUHS','Update-GPOPermissions')
